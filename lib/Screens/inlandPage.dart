...
class _MarinePageState extends State<MarinePage>
    with AutomaticKeepAliveClientMixin<MarinePage> {
  @override
  bool pressed = false;
          ...
          child: NotificationListener<OverscrollIndicatorNotification>(
            ...
            child: FutureBuilder<QuerySnapshot>(
              future: FirebaseFirestore.instance
                  .collection('Products')
                  .where('Productcategory', isEqualTo: 'Marine')
                  .get(),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      visible:
                      (model.Productavailable == "true" ? true : false),
                      child: Padding(
                    ...
                    Visibility(
                      ...
                      child: Padding(
                        padding:
                        EdgeInsets.only(left: 8.0, bottom: 12.0, top: 4.0),
                        child: Row(
                          children: [
                            Visibility(
                              visible:
                              (model.Discount == "true" ? true : false),
                              child: Padding(
                    ...
                    Visibility(
                      visible:
                      (model.Productavailable == "true" ? false : true),
                      child: Padding(
